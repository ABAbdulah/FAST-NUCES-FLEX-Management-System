...
public partial class ins_marks :  System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
       ...
       // string insertQuery = "INSERT INTO weightage (wcol) VALUES (@Value)";
        string insertQuery= "SELECT course_id FROM weigtage WHERE evaluation = @insid";
        ...
        //        if (dataExists)
        //        {
        //            string updateQuery1 = "UPDATE weightage SET wcol = @ass WHERE Course_ID = @data and evaluation = @a";
        //            string updateQuery2 = "UPDATE weightage SET wcol = @quiz WHERE Course_ID = @data and evaluation = @d";
        //            string updateQuery3 = "UPDATE weightage SET wcol = @ss1 WHERE Course_ID = @data and evaluation = @b";
        //            string updateQuery4 = "UPDATE weightage SET wcol = @ss2 WHERE Course_ID = @data and evaluation = @c";
        //            string updateQuery5 = "UPDATE weightage SET wcol = @final WHERE Course_ID = @data and evaluation = @ef";
        //            string updateQuery6 = "UPDATE weightage SET wcol = @project WHERE Course_ID = @data and evaluation = @f";
        ...
        //        else
        //        {
        //            string insertQuery = @"INSERT INTO weightage (evaluation, wcol, course_id)
        //              VALUES (@ass, @w1, @data),
        //                     (@quiz, @w2, @data),
        //                     (@ss1, @w3, @data),
        //                     (@ss2, @w4, @data),
        ...
        //            //string insertQuery1 = "INSERT INTO weightage (evaluation,wcol,course_id) VALUES (@ass, @w1,@data)";
        //            //string insertQuery2 = "INSERT INTO weightage (evaluation,wcol,course_id) VALUES (@quiz, @w2,@data)";
        //            //string insertQuery3 = "INSERT INTO weightage (evaluation,wcol,course_id) VALUES (@ss1, @w3,@data)";
        //            //string insertQuery4 = "INSERT INTO weightage (evaluation,wcol,course_id) VALUES (@ss2, @w4,@data)";
        //            //string insertQuery5 = "INSERT INTO weightage (evaluation,wcol,course_id) VALUES (@final, @w5,@data)";
        //            //string insertQuery6 = "INSERT INTO weightage (evaluation,wcol,course_id) VALUES (@project, @w6,@data)";
